...
MD = HERE / "EgD-WGB-002-Shrish-Setup.md"
OUT = HERE / "EgD-WGB-002-Shrish-Setup.pdf"
...
@page {{
  ...
  @top-left {{
    content: "EVEglyphDesign — Warranty GENE Shrish Setup (EgD-WGB-002)";
    color: #e87722;
...
html_body = re.sub(
    r"^<h1>Warranty GENE — Shrish setup directions</h1>\s*<p>(.+?)</p>",
    lambda m: (
        '<div class="title-block">'
        '<div class="kicker">EVEglyphDesign · Hawkins Twin Platform</div>'
        '<h1>Warranty GENE — Shrish setup directions</h1>'
        '<div class="subtitle">EgD-WGB-002 · Two repositories, six numbered steps, two working days · Build against synthetic data; do not chase credentials</div>'
        f'<p>{m.group(1)}</p>'
        '</div>'
    ),
...
<html><head><meta charset="utf-8"><title>Warranty GENE — Shrish Setup (EgD-WGB-002)</title></head>
<body>{html_body}</body></html>"""

(HERE / "EgD-WGB-002-Shrish-Setup.html").write_text(HTML_DOC, encoding="utf-8")
