...
MD = HERE / "EgD-WGB-004-Luke-Access-Prep-BRP.md"
OUT = HERE / "EgD-WGB-004-Luke-Access-Prep-BRP.pdf"
...
@page {{
  ...
  @top-left {{
    content: "EVEglyphDesign — Warranty GENE Luke Access Prep BRP (EgD-WGB-004)";
    color: #e87722;
...
html_body = re.sub(
    r"^<h1>Warranty GENE — Luke access prep \(BRP\)</h1>\s*<p>(.+?)</p>",
    lambda m: (
        '<div class="title-block">'
        '<div class="kicker">EVEglyphDesign · Hawkins Twin Platform</div>'
        '<h1>Warranty GENE — Luke access prep (BRP)</h1>'
        '<div class="subtitle">EgD-WGB-004 · Tim’s customer service initiative — BRP side · Same backend, different feeds</div>'
        f'<p>{m.group(1)}</p>'
        '</div>'
    ),
...
<html><head><meta charset="utf-8"><title>Warranty GENE — Luke Access Prep BRP (EgD-WGB-004)</title></head>
<body>{html_body}</body></html>"""

(HERE / "EgD-WGB-004-Luke-Access-Prep-BRP.html").write_text(HTML_DOC, encoding="utf-8")
