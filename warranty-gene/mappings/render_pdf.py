...
MD = HERE / "README.md"
OUT = HERE / "WARRANTY-GENE-MAPPINGS.pdf"
...
@page {{
  ...
  @top-left {{
    content: "EVEglyphDesign — Warranty GENE Field Mappings";
    color: #e87722;
...
html_body = re.sub(
    r"^<h1>Warranty GENE — SIR / SmartLINQ / PACCAR Solutions field mappings</h1>\s*<p>(.+?)</p>",
    lambda m: (
        '<div class="title-block">'
        '<div class="kicker">EVEglyphDesign · Hawkins Twin Platform</div>'
        '<h1>Warranty GENE — Field Mappings</h1>'
        '<div class="subtitle">SIR, SmartLINQ, PACCAR Solutions, DAVIE/PRS, TCS365, PRWS</div>'
        f'<p>{m.group(1)}</p>'
        '</div>'
    ),
...
<html><head><meta charset="utf-8"><title>Warranty GENE — Field Mappings</title></head>
<body>{html_body}</body></html>"""

(HERE / "WARRANTY-GENE-MAPPINGS.html").write_text(HTML_DOC, encoding="utf-8")
