"""Render schema/README.md to canon PDF via WeasyPrint.
...
MD = HERE / "README.md"
OUT = HERE / "WARRANTY-GENE-REGISTRATION.pdf"
...
@page {{
  ...
  @top-left {{
    content: "EVEglyphDesign — Warranty GENE Registration & T&Cs";
    color: #e87722;
...
html_body = re.sub(
    r"^<h1>Warranty GENE — Registration and Terms &amp; Conditions data-source inventory</h1>\s*<p>(.+?)</p>",
    lambda m: (
        '<div class="title-block">'
        '<div class="kicker">EVEglyphDesign · Hawkins Twin Platform</div>'
        '<h1>Warranty GENE — Registration & Terms</h1>'
        '<div class="subtitle">PRWS on Fortellis · PSSM Decisiv OWL / VIP · PACCAR Connect · PACCAR Powertrain T&Cs · NHTSA</div>'
        f'<p>{m.group(1)}</p>'
        '</div>'
    ),
...
<html><head><meta charset="utf-8"><title>Warranty GENE — Registration & T&Cs</title></head>
<body>{html_body}</body></html>"""

(HERE / "WARRANTY-GENE-REGISTRATION.html").write_text(HTML_DOC, encoding="utf-8")
