...
MD = HERE / "EgD-WGB-001-Warranty-GENE-Blueprint.md"
OUT = HERE / "EgD-WGB-001-Warranty-GENE-Blueprint.pdf"
...
@page {{
  ...
  @top-left {{
    content: "EVEglyphDesign — Warranty GENE Blueprint (EgD-WGB-001)";
    color: #e87722;
...
html_body = re.sub(
    r"^<h1>Warranty GENE — Sidecar Blueprint</h1>\s*<p>(.+?)</p>",
    lambda m: (
        '<div class="title-block">'
        '<div class="kicker">EVEglyphDesign · Hawkins Twin Platform</div>'
        '<h1>Warranty GENE — Sidecar Blueprint</h1>'
        '<div class="subtitle">EgD-WGB-001 · Modular plugin, integral to the Hawkins Twin, subscription for every other dealer · Follows the Epiq Document B architecture pattern</div>'
        f'<p>{m.group(1)}</p>'
        '</div>'
    ),
...
<html><head><meta charset="utf-8"><title>Warranty GENE — Sidecar Blueprint (EgD-WGB-001)</title></head>
<body>{html_body}</body></html>"""

(HERE / "EgD-WGB-001-Warranty-GENE-Blueprint.html").write_text(HTML_DOC, encoding="utf-8")
