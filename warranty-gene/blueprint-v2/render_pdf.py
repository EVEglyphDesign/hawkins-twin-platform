"""Render EgD-WGB-006 blueprint v2 markdown to canon PDF via WeasyPrint.
...
MD = HERE / "EgD-WGB-006-Warranty-GENE-Blueprint-v2.md"
OUT = HERE / "EgD-WGB-006-Warranty-GENE-Blueprint-v2.pdf"
...
@page {{
  ...
  @top-left {{
    content: "EVEglyphDesign — Warranty GENE Blueprint v2 (EgD-WGB-006)";
    color: #e87722;
...
html_body = re.sub(
    r"^<h1>Warranty GENE — Blueprint v2 \(Two-rooftop, Azure-custody\)</h1>\s*<p>(.+?)</p>",
    lambda m: (
...
<html><head><meta charset="utf-8"><title>Warranty GENE — Blueprint v2 (EgD-WGB-006)</title></head>
<body>{html_body}</body></html>"""

(HERE / "EgD-WGB-006-Warranty-GENE-Blueprint-v2.html").write_text(HTML_DOC, encoding="utf-8")
