...
MD = HERE / "EgD-WGB-005-Luke-Contact-Table.md"
OUT = HERE / "EgD-WGB-005-Luke-Contact-Table.pdf"
...
@page {{
  ...
  @top-left {{
    content: "EVEglyphDesign — Warranty GENE Luke Contact Table (EgD-WGB-005)";
    color: #e87722;
...
html_body = re.sub(
    r"^<h1>Warranty GENE — Luke contact table</h1>\s*<p>(.+?)</p>",
    lambda m: (
        '<div class="title-block">'
        '<div class="kicker">EVEglyphDesign · Hawkins Twin Platform</div>'
        '<h1>Warranty GENE — Luke contact table</h1>'
        '<div class="subtitle">EgD-WGB-005 · Every dealer-support channel for every counterparty · Verified 2026-08-24</div>'
        f'<p>{m.group(1)}</p>'
        '</div>'
    ),
...
<html><head><meta charset="utf-8"><title>Warranty GENE — Luke Contact Table (EgD-WGB-005)</title></head>
<body>{html_body}</body></html>"""

(HERE / "EgD-WGB-005-Luke-Contact-Table.html").write_text(HTML_DOC, encoding="utf-8")
